package com.riezki.composeprojectsubmission.model
...
object AnimeData {
    val listAnime = listOf(
        Anime(
            ...
            overview = "Jika kalian pecinta anime dengan genre fantasy, maka kalian wajib banget nih nonton anime Attack on Titan: The Final Season. Anime ini diadaptasi dari manga populer dengan judul yang sama dan telah memasuki musik keempat yang tentunya ditunggu banyak penggemarnya.",
            img = R.drawable.anime_1,
            date = "Januari 2022",
            genre = "fantasy",
            desc = "Attack on Titan: The Final Season menceritakan tentang perjalanan laki-laki yang bernama Eren Yeager untuk membalaskan dendam atas kematian orang tuanya. Sejak musim pertama, Eren digambarkan sebagai seorang yang begitu membenci para Titan karena mereka yang telah membunuh ibunya. Hingga akhirnya untuk bisa membalas dendam atas kematian ibunya, Eren memutuskan untuk bergabung dengan pasukan pemburu Titan yang bernama Survey Corps. Namun dalam anime Attack on Titan: The Final Season tak hanya menceritakan balas dendam Eren kepada Titan saja.\n" +
                    "Namun juga terdapat unsur misteri dan plot twist di dalam ceritanya. Bahkan di dalam anime Attack on Titan: The Final Season juga terdapat konspirasi politik yang menjadikan anime ini semakin menarik. Attack on Titan Season 4 Part 2 sudah tayang di bulan Januari 2022 dengan jumlah total episode sebanyak 12 penayangan episode.",
            rating = "R",
            studio = "Mappa",
        ),
        Anime(
            ...
            desc = "Untuk melancarkan aksinya, Twilight mengadopsi anak yatim piatu bernama Anya yang nantinya akan diberikan nama Anya Forger. Di sisi lain ternyata Anya memiliki kecerdasan di atas rata-rata bahkan bisa membaca kata hati orang lain. Selain Anya, Loid juga meminta bantuan dari Yor Briar yang berperan sebagai ibu angkat dari Anya Forger. Dibalik kecantikan dan kelembutan Yor Forger, siapa sangka ternyata dirinya merupakan pembunuh bayaran berhati dingin.\n" +
                    ...
                    "\n" +
                    "Anime Spy x Family sudah tayang pada bulan April 2022 yang tentunya bisa kalian saksikan sekarang juga keseruan dari keluarga Forger.",
            rating = "PG-13",
            studio = "Unknown",
        ),
        Anime(
            ...
            desc = "Dikisahkan tentang sebuah organisasi rahasia bernama ARCAM yang telah menguasai Pegunungan Ararat Turki. Di sana mereka berhasil menemukan sebuah benda yang diyakini merupakan Bahtera Nuh.\n" +
                    ...
                    "\n" +
                    "Karena hal tersebutlah ARCAM menginisasi operasi dengan nama Spriggan untuk bisa melawan spremasi tersebut.\n" +
                    "\n" +
                    "Perlu diketahui jika anime Spriggan diadaptasi dari manga dengan judul yang sama. Sebenarnya Spriggan sudah dibuat dalam versi film di tahun 1998 lalu rilisnya. Meski begitu, anime Spriggan tahun 2022 yang dirilis oleh Netflix mampu mengusung visual lebih modern dengan animasi yang tentunya lebih estetik.",
            rating = "PG-13",
            studio = "Unknown",
        ),
        Anime(
            ...
            overview = "Summertime Render adalah rekomendasi anime terbaru di tahun 2022 berikutnya. Anime ini sudah dirilis pada April 2022 dan memiliki total episode sebanyak 25 episode.",
            img = R.drawable.anime_4,
            date = "April 2022 ",
            genre = "Supranatural, action",
            desc = "Summertime Render menceritakan tentang seorang laki-laki bernama Shinpei yang pulang ke kampung halamannya hanya untuk melayat Ushio teman masa kecilnya karena tewas tenggelam. Namun Shinpei tak bisa pulang ke Tokyo begitu saja, pasalnya dirinya melihat tanda cekikan pada bagian leher Ushio.\n" +
                    "\n" +
                    "Shinpei yang tahu akan hal tersebut mencoba untuk memecahkan misteri yang ada dengan bantuan teman-temannya. Akan tetapi misteri gelap akibat rentetan kejadian yang aneh mulai menyebar di seluruh pulau ada kaitannya dengan kematian Ushio.",
            rating = "PG-13",
            studio = "Unknown",
        ),
        Anime(
            ...
            overview = "anime Sono Bisque Doll wa Koi o Suru yang diadaptasi dari serial manga Jepang yang ditulis dan diilustrasikan oleh Shinichi Fukuda. Sono Bisque Doll wa Koi o Suru juga memiliki versi dalam bahasa Inggris dengan judul My Dress Up Darling. Yang mana, anime Sono Bisque Doll wa Koi o Suru sudah tayang pada bulan Januari 2022.",
            img = R.drawable.anime_5,
            date = "Januari 2022",
            genre = "Romance, Ecchi",
            desc = "Sono Bisque Doll wa Koi o Suru menceritakan tentang Wakana Gojo seorang siswa SMA tahun pertama yang memiliki cita-cita menjadi pengrajin boneka hina. Boneka hina merupakan sebuah boneka semacam boneka tradisional dari Jepang yang umumnya akan lebih mudah ditemukan pada festival Hinamatsuri.\n" +
                    "\n" +
                    "Marin Kitagawa yang juga teman sekelas dari Wakana Gojo melihat dirinya sedang membuat sebuah kostum boneka di ruang pakaian sekolah. Marin yang sudah lama suka akan cosplay ini ternyata juga sudah lama mengamati keahlian yang dimiliki oleh Wakana ketika menjahit.",
            rating = "R",
            studio = "Unknown",
        ),
        Anime(
            ...
            desc = "Sudah sejak kecil Komichi Akebi selalu mendambakan seragam sailor, bahkan dirinya pernah meminta ibunya untuk menjahit seragam jika berhasil masuk ke almamater ibunya yaitu Akademi Roubai.\n" +
                    ...
                    "\n" +
                    "Anime Akebi-Chan no Sailor-fuku sudah tayang pada bulan Januari 2022 dengan total episode sebanyak 12 episode.",
            rating = "PG-13",
            studio = "Unknown",
        ),
        Anime(
            id = "7",
            name = "Overlord IV",
            overview = "Overlord IV adalah salah satu anime yang akan tayang pada bulan Juli 2022 dengan jumlah episode yang mungkin saja akan lebih banyak dibandingkan dari seri sebelumnya.",
            img = R.drawable.anime_7,
            date = "Mei 2022.",
            genre = "Action, Isekai",
            desc = "Overlord IV adalah salah satu anime yang akan tayang pada bulan Juli 2022 dengan jumlah episode yang mungkin saja akan lebih banyak dibandingkan dari seri sebelumnya.\n" +
                    "\n" +
                    "Overlord IV merupakan anime yang diadaptasi dari seri light novel dengan judul yang sama dan di tulis oleh Kugane Maruyama serta diilustrasikan oleh So-bin pada 8 Mei 2022.",
            rating = "R",
            studio = "Madhouse",
        ),
        Anime(
            id = "8",
            name = "Made in Abyss: Retsuhitsu ni Ougankyou",
        ...
        Anime(
            ...
            desc = "Mamahaha no Tsurego ga Motokano data adalah sebuah anime yang menceritakan tentang Mizuto Irido dan Yume Ayai yang bertemu secara tak terduga. Setelah putus hubungan, mereka akhirnya bisa bertemu kembali namun dengan status yang berbeda.\n" +
                    ...
                    "\n" +
                    "Mamahaha no Tsurego ga Motokano data memiliki genre comedy dan romance. Anime ini akan tayang pada bulan Juli 2022 ini.",
            rating = "PG-13",
            studio = "Unknown",
        ),
        Anime(
            ...
            desc = "Secara tiba-tiba Ayumu Tanakan seorang siswa tahun pertama memutuskan keluar dari klub kendo dan bergabung dengan klub Shogi yang tidak resmi. Urushi Yaotome seorang presiden dan ahli Shogi begitu senang karena memiliki pasangan bermain.\n" +
                    ...
                    "\n" +
                    "Walaupun Ayumu menyukainya, ia tetap berusaha untuk menahan diri agar tidak mengaku dan berjanji pada dirinya sendiri untuk bisa mengalahkannya terlebih dahulu dalam permainan Shogi.\n" +
                    "Anime Soredemo Ayumu wa Yosetekuru mengusung genre comedy dan slice of life dan akan tayang pada bulan Juli 2022.\n" +
                    "\n",
            rating = "PG-13",
            studio = "Unknown",
        ),
